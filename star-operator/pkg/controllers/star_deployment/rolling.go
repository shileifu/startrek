...
func (r *StarDeploymentReconciler) rolloutRolling(ctx context.Context, d *sr.StarDeployment, rsList []*sr.StarReplicaSet) (ctrl.Result, error) {
	...
	if scaledUp {
		...
		return ctrl.Result{}, r.syncRolloutStatus(ctx, allRSs, newRS, d)
	}

	// Scale down, if we can.
	scaledDown, err := r.reconcileOldReplicaSets(ctx, allRSs, deploymentutil.FilterActiveReplicaSets(oldRSs), newRS, d)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *StarDeploymentReconciler) reconcileNewReplicaSet(ctx context.Context, allRSs []*sr.StarReplicaSet, newRS *sr.StarReplicaSet, deployment *sr.StarDeployment) (bool, error) {
...
func (r *StarDeploymentReconciler) reconcileOldReplicaSets(ctx context.Context, allRSs []*sr.StarReplicaSet, oldRSs []*sr.StarReplicaSet, newRS *sr.StarReplicaSet, deployment *sr.StarDeployment) (bool, error) {
...
func (r *StarDeploymentReconciler) cleanupUnhealthyReplicas(ctx context.Context, oldRSs []*sr.StarReplicaSet, deployment *sr.StarDeployment, maxCleanupCount int32) ([]*sr.StarReplicaSet, int32, error) {
...
func (r *StarDeploymentReconciler) scaleDownOldReplicaSetsForRollingUpdate(ctx context.Context, allRSs []*sr.StarReplicaSet, oldRSs []*sr.StarReplicaSet, deployment *sr.StarDeployment) (int32, error) {
	maxUnavailable := deploymentutil.MaxUnavailable(*deployment)
